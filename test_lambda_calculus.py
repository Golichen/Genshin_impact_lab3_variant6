...
lambda_logger.setLevel(logging.DEBUG)
...
class TestLambdaCalculus(unittest.TestCase):
    ...
    def test_interpret_s_k_k_to_i(self):
        ...
        final_abs = result
        self.assertIsInstance(final_abs.body, Variable)
        self.assertEqual(
            final_abs.var.name, final_abs.body.name
        )
